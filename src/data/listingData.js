...
export const SELLER = {
  ...
  badges: [
    { label: '✓ AWI Florida Chapter Verified', class: 'sb-verified' },
...
export const PRICE_INFO = {
  ...
  checks: [
    '✓ AWI Florida Chapter Verified Seller',
...
export const SAFETY_TIPS = [
  ...
  '✓ AWI Florida Chapter Verified sellers have confirmed business identity',
];
