...
export const JOBS_PAGE_HEADER = {
  eyebrow: 'GrainHub Career Center',
  title: 'Jobs in the\nWood Trades',
...
export const TALENT_CTA = {
  ...
  description: 'Create a free talent profile and let employers find you. 312 companies are actively hiring on GrainHub right now.',
};
